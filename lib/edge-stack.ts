...
const CONFIG = {
  ...
  clientSecret: '{{resolve:secretsmanager:${clientSecretName}:SecretString}}',
  cognitoDomain: '${userPoolDomainPrefix}.auth.${authOutput.region}.amazoncognito.com',
  jwksUri: 'https://cognito-idp.${authOutput.region}.amazonaws.com/${userPoolId}/.well-known/jwks.json',
  issuer: 'https://cognito-idp.${authOutput.region}.amazonaws.com/${userPoolId}',
