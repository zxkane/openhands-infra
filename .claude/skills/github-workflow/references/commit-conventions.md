...
| Scope | Area |
|-------|------|
| `auth` | Authentication (Cognito, Lambda@Edge) |
| `edge` | Edge stack (CloudFront, WAF) |
| `compute` | Compute stack (EC2, ALB) |
...
refactor(edge): extract JWT validation to external file
```
