...
For GitHub development workflow including PR creation, review comment management, and Amazon Q Developer interaction, use the **`github-workflow` skill** in `.claude/skills/github-workflow/`.

**Quick reference:**
- Branch naming: `feat/<name>`, `fix/<name>`, `refactor/<name>`, `docs/<name>`
- Commit format: `type(scope): description`
- Trigger skill with: "create a PR", "address review comments", "/q review"
